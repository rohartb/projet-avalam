...
public class Regle extends JDialog {
	...
	public Regle(Avalam a){
		...
		+ "est de constituer un maximum de tours de 1 à 5 pions, jamais plus,<br>"
		+ "surmontées par un pion de sa couleur. Un joueur<br>"
		...
		+ "Ce mouvement consiste à empiler le ou les pions déplacés sur une<br>"
		+ "case directement voisine déjà occupée par un ou plusieurs pions.<br>"
		+ "<br>"
		...
		+ "<br>"
		+ "<i><small>Source: http://jeuxstrategie.free.fr/Avalam_complet.php</small></i><br>"
		+ "<br>"
		+ "</P>"
		+ "</html>");
